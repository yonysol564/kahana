...
******************************************************************************************/
	...
	function enqueue_my_styles() {
	    ...
	    wp_enqueue_style( 'foundation_rtl', $foundation_rtl, array(), NULL, 'all' );
...
******************************************************************************************/
	...
	function register_my_jscripts() {
		...
		wp_register_script( 'functions', THEME_DIR .'/js/functions.js', array( 'jquery' ), microtime() , true ); wp_enqueue_script( 'functions' );
...
******************************************************************************************/
	...
	// function posts_per_councilmember($query) {
	//     if(is_page_template('tpl-councilMembers.php') ) {
	//         $query->set('posts_per_page', 4);
	//     }
	//     return;
	// }

	// add_action('pre_get_posts', 'posts_per_councilmember');
